...
public class registration extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pu_abs = new javax.swing.JTextField();
        jLabel3 = new javax.swing.JLabel();
        txt_security = new javax.swing.JComboBox<>();
        ...
        pu_abs.setText(" ");
        jPanel1.add(pu_abs);
        pu_abs.setBounds(530, 670, 390, 30);

        jLabel3.setFont(new java.awt.Font("Georgia", 0, 24)); // NOI18N
        jLabel3.setText("Answers");
        jPanel1.add(jLabel3);
        jLabel3.setBounds(330, 660, 100, 28);

        txt_security.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "In which city were you born?", "What was the name of your first pet?", " ", "What is your mother's maiden name?", "What is the name of your favorite childhood friend?" }));
        jPanel1.add(txt_security);
        txt_security.setBounds(520, 610, 400, 30);

        jLabel2.setFont(new java.awt.Font("Georgia", 0, 24)); // NOI18N
        jLabel2.setText("Security Question");
        jPanel1.add(jLabel2);
        jLabel2.setBounds(300, 600, 190, 40);
        ...
        lbl_name.setBounds(250, 280, 160, 30);
        ...
        lbl_password1.setBounds(250, 480, 230, 28);
        ...
        lbl_email.setBounds(250, 420, 230, 30);
        ...
        lbl_number.setBounds(250, 340, 230, 30);
        ...
        btn_signup.setBounds(620, 880, 210, 61);
        ...
        png_rectangle.setBounds(140, 160, 1101, 734);

        getContentPane().add(jPanel1);
        jPanel1.setBounds(20, 80, 1460, 1024);

        setSize(new java.awt.Dimension(1456, 1075));
    ...
    private void btn_signupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_signupActionPerformed
        // TODO add your handling code here:
            ...
            String securityQuestion= txt_security.getselection();
            String answer= pu_abs.getText();
...
//    }
        ...
        if (setpassword.equals(retypepassword)) {
            String sql = "INSERT INTO register (USERNAME,NUMBER , EMAIL, PASSWORD, CONFIRM_PASSWORD,SECURITY_QUESTION,ANSWER) VALUES ('" + username+ "','" + phonenumber  + "','" + email + "','" + setpassword + "','" + retypepassword + "','"+securityquestion+"','"+answer+"')";
